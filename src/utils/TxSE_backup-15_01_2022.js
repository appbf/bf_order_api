...
class TxSE {
    ...
    async #setTakerFee() {
        ...
        try {
            ...
            createLog({ titel: 'Error from setTakerFee : ', error: error.message });
        }
    }
    async #setMakerFee() {
        ...
        try {
            let ws = await WebsiteData.findOne({});
            this.#taker_fee = parseFloat(ws && ws.maker_fee ? ws.maker_fee : 0);
        } catch (error) {
            createLog({ titel: 'Error from setMakerFee : ', error: error.message });
        }
    }
    ...
    async #setOppositOrders() {
        ...
        if (this.#order_direction == 'sell') {
            ...
            try {
                ...
                createLog({ titel: 'Error from setOppositOrders 1: ', error: error.message });
            }
            ...
            try {
                ...
                createLog({ titel: 'Error from setOppositOrders 2: ', error: error.message });
            }
        } else {
    ...
    async #lockSelf() {
        ...
        if (this.#order_direction == 'sell') {
            try {
                ...
                createLog({ titel: 'Error from lockSelf 1: ', error: error.message });
            }
        } else if (this.#order_direction == 'buy') {
            try {
                ...
                createLog({ titel: 'Error from lockSelf 2: ', error: error.message });
            }
        } else {
            // invalid order direction
        }
    ...
    async #unlockSelf() {
        ...
        if (this.#order_direction == 'sell') {
            try {
                ...
                createLog({ titel: 'Error from unlockSelf 1: ', error: error.message });
            }
        } else if (this.#order_direction == 'buy') {
            try {
                await BuyStack.updateOne({ order_id: this.#order_id }, {
                ...
                createLog({ titel: 'Error from unlockSelf 2: ', error: error.message });
            }
        } else {
            // invalid order direction
        }
    ...
    async #lockOppositOrders() {
        ...
        if (this.#order_direction == 'sell') {
            try {
                ...
                createLog({ titel: 'Error from lockOppositOrders 1: ', error: error.message });
            }
        } else if (this.#order_direction == 'buy') {
            try {
                ...
                createLog({ titel: 'Error from lockOppositOrders 2: ', error: error.message });
            }
        } else {
            // invalid order direction
        }
    ...
    async #unlockOppositOrders() {
        ...
        if (this.#order_direction == 'sell') {
            try {
                ...
                createLog({ titel: 'Error from unlockOppositOrders 1: ', error: error.message });
            }
        } else if (this.#order_direction == 'buy') {
            try {
                await SellStack.updateMany({ _id: { "$in": this.#opposit_locked_orders_ids } }, {
                ...
                createLog({ titel: 'Error from unlockOppositOrders 2: ', error: error.message });
            }
        } else {
            // invalid order direction
        }
    ...
    async #createTradeHistory() {
        ...
        try {
            ...
            createLog(this.#trade_history, HISTORY_UPDATE_LOG)
        } catch (error) {
            createLog({ titel: 'Error from createTradeHistory 1: ', error: error.message });
        }
    }
    async #updateSelfMainWallet() {
        ...
        try {
            ...
            if (this.#order_direction == 'sell') {
                let new_balance = sub(sub(currency_wallet.balance, this.#self_wallet.balance), this.#calculateMakerFee(this.#self_wallet.balance)); // subtract fee 
                ...
                createLog(this.#createHistoryObject(
                    currency_wallet,
                ...
                let compare_currency_change = mul(this.#self_wallet.balance, this.#raw_price);
                let new_balance_cc = sub(sub(compare_currency_wallet.balance, compare_currency_change), this.#calculateTakerFee(compare_currency_change)); // diduct fee
            ...
            createLog({ titel: 'Error from updateSelfMainWallet [parent]: ', error: error.message });
        }
    }
    async #updateSelfMainOrder() {
        ...
        if (this.#order_direction == 'sell') {
            try {
                ...
                createLog({ titel: 'Error from updateSelfMainOrder 1: ', error: error.message });
            }
        } else if (this.#order_direction == 'buy') {
            try {
                await BuyStack.updateOne({ order_id: this.#order_id }, {
                ...
                createLog({ titel: 'Error from updateSelfMainOrder 2: ', error: error.message });
            }
        } else {
            // invalid order
        }
        ...
        try {
            ...
            if (this.#order_direction == 'sell') {
                ...
                for (let i = 0; i < opposit_c_main_wallet.length; i++) {
                    ...
                    let new_cc_balance = sub(sub(opposit_cc_main_wallet[i].balance, compare_currency_change), this.#calculateTakerFee(compare_currency_change)); // diduct fee
                ...
                createLog(l_c, WALLET_UPDATE_LOG);
            } else if (this.#order_direction == 'buy') {
                let q_c = [];
                let q_cc = [];
                let l_c = [];
                for (let i = 0; i < opposit_c_main_wallet.length; i++) {
                    let user_id = opposit_c_main_wallet[i].user;
                    let new_c_balance = sub(sub(opposit_c_main_wallet[i].balance, this.#opposit_wallet[user_id]), this.#calculateMakerFee(this.#opposit_wallet[user_id]));
            ...
            createLog({ titel: 'Error from updateOppositMainWallet [parent]: ', error: error.message });
        }
    }
    async #updateWalletByBulkWriter(argument) {
        try {
            ...
            createLog({ titel: 'Error from updateWalletByBulkWriter : ', error: error.message });
            return false;
        }
    }
    async #updateOppositOrderByBulkWriter(argument) {
        try {
            ...
            createLog({ titel: 'Error from updateOppositOrderByBulkWriter : ', error: error.message });
            return false;
        }
    }
    async #updateOppositMainOrder() {
        ...
        createLog(o_h, ORDER_UPDATE_LOG);
    }
    async #getOppositCurrencyMainWallets() {
        ...
        if (opposit_user_ids.length > 0) {
            try {
                ...
                createLog({ titel: 'Error from getOppositCurrencyMainWallets : ', error: error.message });
                return [];
            }
        } else {
            return [];
    ...
    async #getOppositCompareCurrencyMainWallets() {
        ...
        if (opposit_user_ids.length > 0) {
            try {
                ...
                createLog({ titel: 'Error from getOppositCompareCurrencyMainWallets : ', error: error.message });
                return [];
            }
        } else {
            return [];
